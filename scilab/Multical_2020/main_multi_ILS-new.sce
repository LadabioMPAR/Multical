...
kmax = 5; // está relacionado com os componentes que estão contidos na amostra (não colocar muito )
...
pretreat = list({'SG',6,1,3,1,1},{'Cut',240,470,1});// controle de baseline todos
...
flag = func_multi_ILS_new(Selecao,optkini,lini,kmax,nc,cname,unid,x0,absor0,frac_test,dadosteste,OptimModel,pretreat,analysis,outlier,gravarXval)
